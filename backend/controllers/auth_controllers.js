...
// Placeholder OTP endpoints to keep routes functional. Real OTP logic has been removed.
const sendOtp = async (req, res) => {
    return res.status(501).json({ status: false, msg: "OTP service is disabled in this build." });
};
